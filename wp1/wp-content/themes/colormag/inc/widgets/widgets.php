...
class colormag_featured_posts_slider_widget extends WP_Widget {
   ...
   function colormag_featured_posts_slider_widget() {
      $widget_ops = array( 'classname' => 'widget_featured_slider widget_featured_meta', 'description' => __( 'Display latest posts or posts of specific category', 'colormag') );
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: Featured Cat Slider', 'colormag' ),$widget_ops);
   }
...
class colormag_featured_posts_widget extends WP_Widget {
   ...
   function colormag_featured_posts_widget() {
      ...
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: Featured Posts', 'colormag' ),$widget_ops);
   }
...
class colormag_featured_posts_vertical_widget extends WP_Widget {
   ...
   function colormag_featured_posts_vertical_widget() {
      ...
      $control_ops = array( 'width' => 200, 'height' =>250 );
      parent::WP_Widget( false,$name= __( 'TG: Featured Posts Vertical', 'colormag' ),$widget_ops);
   }
